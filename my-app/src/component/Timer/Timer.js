...
export default class Timer extends React.Component {
    componentDidMount() {
        ...
        var deadline = new Date(Date.parse(new Date()) + `${this.props.time}` * 24 * 60 * 60 * 1000); // for endless timer
        initializeClock(this.props.id, deadline);
    }
    render() {
        return (
            <>
                <div id={this.props.id} className="countdown">
